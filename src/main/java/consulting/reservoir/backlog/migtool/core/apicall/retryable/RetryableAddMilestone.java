...
/**
 * Backlog API の `addMilestone` をリトライ付きで呼び出すことを可能にするクラス。
 */
public class RetryableAddMilestone extends AbstractRetryableApiCallout {
    private AddMilestoneParams params;
    private Milestone result;

    /**
     * コンストラクタ.
     */
    public RetryableAddMilestone(AddMilestoneParams params) {
        this.params = params;
    }
    ...
    void processApiCallout(RsvrBacklogApiConn bklConn) throws BacklogException {
        result = bklConn.getClient().addMilestone(params);
    }

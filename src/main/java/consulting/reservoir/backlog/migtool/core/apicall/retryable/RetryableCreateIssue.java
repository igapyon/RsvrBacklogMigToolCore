...
/**
 * Backlog API の `createIssue` をリトライ付きで呼び出すことを可能にするクラス。
 */
public class RetryableCreateIssue extends AbstractRetryableApiCallout {
     ...
     * コンストラクタ.
     */
    public RetryableCreateIssue(CreateIssueParams params) {
        this.params = params;
    }
    ...
    void processApiCallout(RsvrBacklogApiConn bklConn) throws BacklogException {
        result = bklConn.getClient().createIssue(params);
    }

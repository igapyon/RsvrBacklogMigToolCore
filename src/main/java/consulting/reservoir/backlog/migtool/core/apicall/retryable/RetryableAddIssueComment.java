...
/**
 * Backlog API の `addIssueComment` をリトライ付きで呼び出すことを可能にするクラス。
 */
public class RetryableAddIssueComment extends AbstractRetryableApiCallout {
    private AddIssueCommentParams params;
    private IssueComment result;

    /**
     * コンストラクタ.
     */
    public RetryableAddIssueComment(AddIssueCommentParams params) {
        this.params = params;
    }
    ...
    void processApiCallout(RsvrBacklogApiConn bklConn) throws BacklogException {
        result = bklConn.getClient().addIssueComment(params);
    }

...
/**
 * Backlog API の `addVersion` をリトライ付きで呼び出すことを可能にするクラス。
 */
public class RetryableAddVersion extends AbstractRetryableApiCallout {
    private AddVersionParams params;
    private Version result;

    /**
     * コンストラクタ.
     */
    public RetryableAddVersion(AddVersionParams params) {
        this.params = params;
    }
    ...
    void processApiCallout(RsvrBacklogApiConn bklConn) throws BacklogException {
        result = bklConn.getClient().addVersion(params);
    }

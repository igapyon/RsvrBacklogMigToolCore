 ...
 */
public class RsvrBacklogMapExpUser {
    private Connection conn = null;
    private RsvrBacklogApiConn bklConn = null;

    public RsvrBacklogMapExpUser(Connection conn, RsvrBacklogApiConn bklConn) {
        this.conn = conn;
    ...
    private void mapping() throws SQLException, IOException {
        // 現状の User 情報をもとに、まずはプレーンなユーザ一覧を作成。
        H2MappingUserDao.setupInitialData(conn, bklConn);

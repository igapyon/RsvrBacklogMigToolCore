...
これは、たいていの一般的な JDBCプログラミングでは参照しているレコードを進めたり戻したりする際に columnIndex を1へとリセットすることが観察されたことからも、上記のような仕様としています。
...
また、RsvrPreparedStatement#resetParameterIndex メソッドを明示的に呼び出すことによっても parameterIndex のリセットを行うことが可能です。
